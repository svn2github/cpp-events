...
strongly recommended to install the Framework, build and run test suilt on your
system.
...
MSVS project. Please not that C# test runs wery quickly, but hangs for a very
...
Subdirectory 'build/cmake' containts input files for CMake. Subdirectory
